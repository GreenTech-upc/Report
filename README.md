...
| US-41 | Explicación del funcionamiento de la plataforma| Como visitante, quiero ver una guía paso a paso del flujo de trabajo para entender la facilidad del proceso. | **Scenario: Revisión del flujo operativo** <br> *Given* el visitante lee la sección "Cómo funciona" <br> <br> *When* observa la línea de tiempo interactiva <br> *Then* comprende de forma visual e intuitiva la interacción entre el dron, la nube y su dispositivo. | EP-08 |
